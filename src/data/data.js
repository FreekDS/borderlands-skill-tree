    ...
    children: [
      {
        ...
        icon: suspensionIcon,
        title: "Suspension",
        tooltip: { description: "Increases the duration of Phaselock." },
        children: [
          {
            id: "fleet",
            icon: fleetIcon,
                ...
                children: [
                  {
                    ...
                    icon: quickenIcon,
                    title: "Quicken",
                    tooltip: { description: "Increases the cooldown rate of your phaselock ability." },
                    children: []
                  }
                ]
              },
        ...
        children: [
          {
            ...
            icon: elatedIcon,
            title: "Elated",
            tooltip: { description: "While you have an enemy Phaselocked you and your friends regenerate health." },
            children: [
              {
                id: "life-tap",
                icon: lifeTapIcon,
                title: "Life Tap",
                tooltip: { description: "Killing an enemy causes you to steal health from any enemy you damage. This effect lasts a short while." }
                ,
                children: [
                  {
                    id: "scorn",
          ...
          },
          {
            ...
            title: "Sweet Release",
            tooltip: { description: "Increases damage and bullet speed with all gun types." },
            children: [
              {
                id: "wreck",
                icon: wreckIcon,
                title: "Wreck",
                tooltip: { description: "While you have an enemy Phaselocked you gain increased fire rate and damage with all gun types." },
                children: [
                  {
                    id: "recompense",
                    icon: recompenseIcon,
                    title: "Recompense",
                    tooltip: { description: "When you take health damage there is chance your attacker takes damage equal to the amount of health you lost. " },
                    children: []
                  }
                ]
              },
              {
                ...
                icon: resIcon,
                title: "Res",
                tooltip: { description: "You can instantly revive your friend in Fight for your Life by using Phaselock on him/her." },
                children: []
              }
            ]
          }
...
export const cataclysm = [
  {
    ...
    icon: flickerIcon,
    title: "Flicker",
    tooltip: { description: "Increases your chance to cause status effects with Fire, Shock, Corrosive and Slag guns." },
    children: [
      {
        id: "immolate",
        icon: immolateIcon,
        title: "Immolate",
        tooltip: { description: "Adds fire damage to all of your shots fired while in Fight for your Life. The additional fire damage is based on the damage of the weapon you're firing." },
        children: [
          {
            id: "chain-reaction",
            icon: chainReactionIcon,
            title: "Chain Reaction",
            tooltip: { description: "While you have an enemy Phaselocked all of your shots that hit enemies have a chance to ricochet and hit another nearby enemy. Chain Reaction only works with bullets." },
            children: [
              {
                id: "cloud-kill",
                icon: cloudKillIcon,
                title: "Cloud Kill",
                tooltip: { description: "Shooting an enemy creates a lingering acid cloud, dealing constant corrosive damage to enemies who touch it. Only one acid cloud can be active at a time. " },
                children: [
                  {
                    id: "reaper",
                    icon: reaperIcon,
                    title: "Reaper",
                    tooltip: { description: "You deal increased damage to any enemy that has more than 50% of his health remaining." },
                    children: []
                  },
                  {
                    id: "blight-phoenix",
                    ...
                    tooltip: { description: "Killing an enemy causes you to deal constant fire and corrosive damage to nearby enemies for a short time. The damage is based on your level and the level of Blight Phoenix." },
                    children: []
                  }
                ]
              }
      ...
      },
      {
        ...
        icon: forsightIcon,
        title: "Forsight",
        tooltip: { description: "Increases magazine size and reload speed with all weapon types." },
        children: [
          {
            id: "helios",
            icon: heliosIcon,
            title: "Helios",
            tooltip: { description: "Phaselocking an enemy causes a fiery explosion, damaging any nearby enemies." },
            children: [
              {
                id: "backdraft",
                icon: backdraftIcon,
                title: "Backdraft",
                tooltip: { description: "Your melee attacks deal additional fire damage. Also, when your shields become depleted, you create a fiery explosion, damaging nearby enemies. Your shields must fully recharge between explosions." },
                children: []
              },
              {
                id: "ruin",
                icon: ruinIcon,
                title: "Ruin",
                tooltip: { description: 'Phaselock now Slags, Electrocutes, and Corrodes all nearby enemies. "Ignorance and Inconsideration may be greater causes of ruin, but they are slow and lacking in spectacle"' },
                children: []
              }
            ]
          }
